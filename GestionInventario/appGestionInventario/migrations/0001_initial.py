...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('depNombre', models.CharField(db_comment='Nombre del Deposito', max_length=50)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ubiEstante', models.CharField(db_comment='Número de bodega: 1,2,3,4..', max_length=50, null=True)),
                ('ubiEntrepano', models.CharField(db_comment='Número de Entrepaño: 1,2,3,4..', max_length=50, null=True)),
                ('ubiLocker', models.CharField(db_comment='Número de locker: 1,2,3,4..', max_length=50, null=True)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('ubiDeposito', models.ForeignKey(db_comment='Hace referencia al deposito o bodega', on_delete=django.db.models.deletion.PROTECT, to='appGestionInventario.deposito')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solFechaHoraDevolver', models.DateTimeField(db_comment='Fecha y hora que devuelve los elementos', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manTipo', models.CharField(choices=[('Predictivo', 'Predictivo'), ('Correctivo', 'Correctivo')], db_comment='Tipo de Mantenimiento', max_length=50, null=True)),
                ('manObservaciones', models.TextField(db_comment='Observaciones que se quieran agregar                                 al mantenimiento', null=True)),
                ('manRealizadoPor', models.TextField(db_comment='Relación de aprendices o personal externo                                 que realizó y/o apoyo en el mantenimiento', null=True)),
                ('manFechaMantenimiento', models.DateTimeField(db_comment='Fecha y hora que se realizó el mantenimiento', null=True)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
        ...
        migrations.CreateModel(
            name='HojaVidaDevolutivo',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hojaMarcaMotor', models.CharField(db_comment='Marca del Motor del Elemento', max_length=45, null=True)),
                ('hojaModelo', models.CharField(db_comment='Modelo del Motor', max_length=45, null=True)),
                ('hojaFabricante', models.CharField(db_comment='Fabricante del Elemento', max_length=45, null=True)),
                ('hojaTipoCombustible', models.CharField(db_comment='Tipo de Combustible', max_length=45, null=True)),
                ('hojaTipoAceiteMotor', models.CharField(db_comment='Tipo de Aceite del Motor', max_length=45, null=True)),
                ('hojaPotenciaMotor', models.CharField(db_comment='Potencia del Motor', max_length=45, null=True)),
                ('hojaRangoDeTrabajo', models.CharField(db_comment='Rango de Trabajo dada en RPM', max_length=45, null=True)),
                ('hojaVoltaje', models.CharField(db_comment='Tipo de Voltaje 110V - 220V', max_length=45, null=True)),
                ('hojaPeso', models.FloatField(db_comment='Peso del elemento en KG', null=True)),
                ('hojaDevolutivo', models.OneToOneField(db_comment='Hace relación al devolutivo FK', on_delete=django.db.models.deletion.PROTECT, to='appGestionInventario.devolutivo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entFechaHora', models.DateTimeField(db_comment='Fecha y hora que entregan los elementos', default=datetime.datetime(2023, 11, 28, 23, 22, 32, 957619, tzinfo=datetime.timezone.utc))),
        ...
        migrations.AddField(
            ...
            name='devElemento',
            field=models.ForeignKey(db_comment='Hace relación al elemento FK', on_delete=django.db.models.deletion.PROTECT, to='appGestionInventario.elemento'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_comment='Unidad de médida del elemento que se requeire', null=True, on_delete=django.db.models.deletion.PROTECT, to='appGestionInventario.unidadmedida'),
        ),
        migrations.CreateModel(
